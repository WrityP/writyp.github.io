...
behaviors = {
	...
	brave:{
		...
		title:'Brave',
		description:"This one think of himself as the hero of this story, his main purpose is to not seem like a coward.",
		fill:'gold'
	},
...
var Character = function(id,behavior = behavior_keys.random()){
	this.id = id;
...
Character.prototype.setBehavior = function(){
	...
	$("#opponent_screen .actions").append($c);
	$('#opponent_screen h1').html(this.behavior.title+" fighter");
	$('#bottom_half').append(this.behavior.description);
	console.log($c);
}
